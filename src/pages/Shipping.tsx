    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 justify-center items-center md:grid-cols-2 lg:grid-cols-2 gap-6 mb-12">
            <Fade direction="right" className='justify-center items-center'>
              {freeShippingZones.map((zone, index) => (
                <div
                  key={zone.code}
                  className="bg-gradient-to-br from-green-50 to-green-100 justify-center items-center rounded-2xl p-6 text-center border-2 border-green-200 hover:border-green-300 transition-colors duration-200 animate-slide-up"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              >< Bounce>
                ...
                <p className="text-gray-600">{step.description}</p></Bounce>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <div className="space-y-3 text-gray-700">
                  <Rotate direction="top-left" cascade>
                  <p>
                    <strong>Zones de livraison gratuite :</strong> Cococodji,Calavi
                  </p>
                  <p>
                    <strong>Autres zones :</strong> Frais de livraison dépendant de la zone
                  </p>
                  <p>
                    <strong>Délais :</strong> 24-48h pour les zones gratuites, 2-3 jours pour les autres zones
                  </p>
                  <p>
                    <strong>Paiement :</strong> Paiement à la livraison disponible
                  </p>
                  <p>
                    <strong>Contact :</strong> Pour toute question, contactez-nous au +229 52 35 34 84
                  </p>
                  </Rotate>
                </div>
              </div>
